...
const LABS = [
  ...
  { topic: 'authentication', num: 5, dir: 'Authentication', script: 'exploit-lab05.py', title: 'Username enumeration via response timing', timeout: 900000 },
...
async function main() {
  console.log('\nRetry Batch: High Probability Labs\n');
  ...
  console.log(`\n========================================`);
  console.log(`Retry Result: ${solved} solved, ${failed} failed, ${skipped} skipped`);
  console.log(`========================================\n`);
  await browser.close();
}
